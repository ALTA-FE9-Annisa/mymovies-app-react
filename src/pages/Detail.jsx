...
const Detail = (props) => {
  ...
  return (
    <section className="pt-20 px-7 lg:px-20 py-3 h-full w-full  mb-[10rem]">
      <div
      ...
      <div className="w-full h-[500px] ">
        ...
        <div className="h-[144px] w-[440px] bg-card-detail backdrop-blur-md rounded-3xl  relative z-[5] top-[-15%] left-[4%] p-7">
          ...
          <h2 className="text-3xl font-semibold text-abu-50 ">{data?.title}</h2>
        </div>
      </div>

      <div className="flex justify-between gap-20 pt-[200px]">
        <img
